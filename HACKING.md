...
hidden if the `tetris_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `tetris_DEVELOPER_MODE` to the configure
...
Runs the executable target `tetris_exe`.
